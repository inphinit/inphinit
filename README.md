...
1. Alternate is download GIT repository and copy content from zip file to folder project (don't clone `master` for production use), clone last release example:
    ```
    git clone -b "0.3.0" https://github.com/inphinit/inphinit.git [project_name]
    git clone -b "0.3.0" https://github.com/inphinit/framework.git [project_name]/system/vendor/inphinit/framework
    cd [project_name]
    ```
